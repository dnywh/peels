-- Replace the old database webhook wrapper with a private trigger function
-- that authenticates the Edge Function call using a non-public shared secret.
...
create trigger webhook_new_chat_message
  ...
  for each row
  execute function private.notify_new_chat_message();
