...
Last updated: <Hyperlink href={`${siteConfig.repoUrl}/commits/main/src/app/(core)/(static)/(text)/privacy`} target="\_blank">11th May 2025</Hyperlink>
...
Please <EncodedEmailHyperlink address={siteConfig.email.support}>contact us</EncodedEmailHyperlink> if you have questions or concerns about this privacy policy, or wish to exercise your rights.
