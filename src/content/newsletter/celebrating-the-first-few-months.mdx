...
export const customMetadata = {
  issueNumber: 1,
  verboseTitle: "Celebrating the first few months of Peels",
...
**Please <EncodedEmailLink address={siteConfig.encodedEmail.dw}>reach out</EncodedEmailLink> if you or someone you know can help promote Peels in your local area**. Whether it’s to councils, waste educators, or local networks, any help is appreciated. <StrongLink href={siteConfig.links.share}>Spread the word</StrongLink> is also a good place to start.
...
<NewsletterImage
  ...
  caption={
    <>
      ...
      <Link href={siteConfig.repoUrl} target="_blank" rel="noopener">
        the code
      </Link>
      !
    </>
