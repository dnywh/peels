...
<StrongLink href="https://next-intl.dev/" target="_blank">
  next-intl
</StrongLink>
extends Next.js to make language translations straightforward.
<StrongLink href="http://crowdin.com" target="_blank">
  Crowdin
</StrongLink>
provides a handy web interface for volunteer translators to contribute their
expertise.
